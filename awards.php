...
<div class="principal">
	<div class="textContent">
		...
		<div class="awardItem">
			<div class="contenido">
				<div class="titulos">
					...
					<h4 class="scrollAnimation">Shenzhen, China.</h4>
				</div>
			...
			<div class="awardImg scrollAnimation">
				<img src="images/awards/idea-tops.jpg">
		...
		<div class="awardItem">
			<div class="contenido">
				...
				<div class="descripcion">
						<b class="scrollAnimation">WINNER</b>
						<b class="scrollAnimation">Categories: Details Plus Architecture + Wood</b>
						<b class="scrollAnimation">Projects: SFER IK Museion Uh May (Jury Winner)</b>
					<span class="scrollAnimation"></span>
			...
			<div class="awardImg scrollAnimation">
				<img src="images/awards/architizer-01.jpg">
		...
		<div class="awardItem">
			<div class="contenido">
				...
				<div class="descripcion">
								<b class="scrollAnimation">WINNER</b>
						<b class="scrollAnimation">Categories: Residential Private House (XL > 500 sq. ft.) </b>
						<b class="scrollAnimation">Projects: AZULIK Residence (Special Mention)</b>
					<span class="scrollAnimation"></span>
				</div>
			</div>
			<div class="awardImg scrollAnimation">
				<img src="images/awards/architizer-02.jpg">
		...
		<div class="awardItem">
			<div class="contenido">
				<div class="titulos">
					<h3 class="scrollAnimation">SBID INTERNATIONAL DESIGN AWARDS</h3>
					<h4 class="scrollAnimation">London, England.</h4>
				</div>
				<div class="descripcion">
					<b class="scrollAnimation">WINNER</b>
					<b class="scrollAnimation">Category: Overall Winner</b>
					<b class="scrollAnimation">Project: AZULIK Residence</b>
					<span class="scrollAnimation"></span>
					<p class="scrollAnimation">The SBID International Design Awards are one of the world’s most prestigious interior design accolades. Attracting entries from all over the globe and evaluated by leading industry experts, they celebrate and reward design excellence across a range of categories for their aesthetic creativity and inspiring potential.</p>
				</div>
			</div>
			<div class="awardImg scrollAnimation">
				<img src="images/awards/sbid.jpg">
		...
		<div class="awardItem">
			<div class="contenido">
				<div class="titulos">
					<h3 class="scrollAnimation">Frame Awards</h3>
					<h4 class="scrollAnimation">Amsterdam, Netherlands.</h4>
				</div>
				<div class="descripcion">
					<b class="scrollAnimation">WINNER</b>
					<b class="scrollAnimation">Categories: House of the Year</b>
					<b class="scrollAnimation">Projects: AZULIK Residence</b>
					<span class="scrollAnimation"></span>
			...
			<div class="awardImg scrollAnimation">
				<img src="images/awards/frame-awards-01.jpg">
		...
		<div class="awardItem">
			<div class="contenido">
				...
				<div class="descripcion">
						<b class="scrollAnimation">WINNER</b>
						<b class="scrollAnimation">Categories: Emerging Designer of the Year</b>
						<b class="scrollAnimation">Projects: Roth Architecture </b>
					<span class="scrollAnimation"></span>
				</div>
			</div>
			<div class="awardImg scrollAnimation">
				<img src="images/awards/frame-awards-02.jpg">
				 <a href="https://frameweb.com/article/proudly-announcing-the-full-list-of-frame-awards-winners " target="_blank">Read More</a>
				<div class="linea"></div>
			</div>
		</div>
		...
		<div class="awardItem">
			<div class="contenido">
				<div class="titulos">
					<h3 class="scrollAnimation">LCD Berlin Awards</h3>
					<h4 class="scrollAnimation">Berlin, Germany.</h4>
				</div>
				<div class="descripcion">
					<b class="scrollAnimation">WINNER</b>
					<b class="scrollAnimation">Category: New Culture Destination of the Year</b>
					<b class="scrollAnimation">Project: SFER IK  Museion</b>
					<span class="scrollAnimation"></span>
					<p class="scrollAnimation">The Leading Culture Destinations Berlin Awards highlight the most remarkable, established, and emerging, cultural initiatives around the world – with nominees representing 50 cultural destinations from 28 countries. The “Oscars of museums” shine a light on the most exceptional offerings of the world’s cultural organizations.</p>
				</div>
			</div>
			<div class="awardImg scrollAnimation">
				<img src="images/awards/lcd.jpg">
	...
	<div class="awardItem">
		<div class="contenido">
			<div class="titulos">
				<h3 class="scrollAnimation">BUILD ARCHITECTURE AWARDS 2020 </h3>
				<h4 class="scrollAnimation">Staffordshire, England.</h4>
			</div>
			<div class="descripcion">
				<b class="scrollAnimation">WINNER</b>
				<b class="scrollAnimation">Category: Best Artistic Architecture Studio </b>
				<b class="scrollAnimation">Project: Roth Architecture</b>
				<span class="scrollAnimation"></span>
				<p class="scrollAnimation">BUILD Awards recognise and reward the works conducted by the world’s most innovative, imaginative and dedicated designers and architects. <br>With an impetus on sustainable and efficient methods being placed on modern projects, the awards recognise those that are pioneers in passive design. The Architecture Awards 2020 commend companies, individuals and projects across a myriad of sectors and through a merit-driven approach, that  ensures that only the most dedicated, creative and awe-inspiring parties receive one of the prestigious accolades.</p>
			</div>
		</div>
		<div class="awardImg scrollAnimation">
	...
	<div class="awardItem">
		<div class="contenido">
			...
			<div class="descripcion">
					<b class="scrollAnimation">WINNER</b>
					<b class="scrollAnimation">Category: Best Completed Innovative Commercial Project </b>
					<b class="scrollAnimation">Project: ZAK IK</b>
				<span class="scrollAnimation"></span>
			</div>
		</div>
		<div class="awardImg scrollAnimation">
			<img src="images/awards/build-arch-02.jpg">
			 <a href="https://www.build-review.com/issues/architecture-awards-2020/48/" target="_blank">Read More</a>
			<div class="linea"></div>
		</div>
	</div>
