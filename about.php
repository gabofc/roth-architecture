	...
	<div class="textContent">
		...
		<div class="scrollPosition">
			...
			<div class="aboutItem">
				...
				<div class="aboutImg scrollAnimation"><img src="" data-src="images/about/About2.jpg" class="mainImg lazyload"><span class="caption">AZULIK Residence</span></div>
			</div>
			<div class="aboutItem vertical">
				<div class="aboutImg scrollAnimation"><img src="" data-src="images/about/About3.jpg" class="mainImg lazyload"><span class="caption">AZULIK Residence</span></div>
				<div class="aboutContent">
